...
let Keyboard = SoundPack(name: "Keyboard", type: .Keyboard, A: A_Keyboard, AS: AS_Keyboard, B: B_Keyboard, C: C_Keyboard, CS: CS_Keyboard, D: D_Keyboard, DS: DS_Keyboard, E: E_Keyboard, F: F_Keyboard, FS: FS_Keyboard, G: G_Keyboard, GS: GS_Keyboard)
